  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Dash.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end
    ...
    strategies do
      magic_link do
        ...
        sender Dash.Accounts.User.Senders.SendMagicLinkEmail
      end
      ...
      password :password do
        ...
        resettable do
          sender Dash.Accounts.User.Senders.SendPasswordResetEmail
