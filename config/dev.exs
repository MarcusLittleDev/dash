...
config :dash, DashWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "OXSHnhAqv2SFW90tnqF9FQ8mrGSg2iIyEE9CYtg4c7Snc/w8uPeUok1His40od6Q",
  watchers: [
...
config :dash, DashWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/dash_web/router\.ex$"E,
      ~r"lib/dash_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
